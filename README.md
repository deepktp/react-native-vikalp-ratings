<p align="center">
  <a href="https://github.com/deepktp/react-native-vikalp-ratings">
...
<p align="center">
  <a href="https://www.npmjs.com/package/@rn-vui/ratings"><img src="https://img.shields.io/npm/v/@rn-vui/ratings.svg?style=flat-square"></a>
  <a href="https://www.npmjs.com/package/@rn-vui/ratings"><img src="https://img.shields.io/npm/dm/@rn-vui/ratings.svg?style=flat-square"></a>
</p>
...
`yarn add '@rn-vui/ratings'`

OR

`npm install --save '@rn-vui/ratings'`

## Usage

```js
import { Rating, AirbnbRating } from '@rn-vui/ratings';
...
| style                 | none            | style                    | Exposes style prop to add additional styling to the container view (optional)                                                                                |
...
This repo is being actively maintained. Feel free to open a new Issue with a `Feature Request` or submit a PR with an `Enhancement`.
